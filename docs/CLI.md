...
**Nota:** O dangerfile gerado usa `executeDangerBot` com `allFlutterPlugins` (todos os 25 plugins). Para customizar, veja exemplos com callbacks na [API Reference](API.md).
