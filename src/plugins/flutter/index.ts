...
export { default as domainRepositoriesPlugin } from "./domain-repositories";
...
export { default as dataRepositoriesPlugin } from "./data-repositories";
export { default as presentationViewModelsPlugin } from "./presentation-viewmodels";
export { default as presentationStatesPlugin } from "./presentation-states";
