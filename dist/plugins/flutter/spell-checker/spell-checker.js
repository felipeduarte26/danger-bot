...
exports.default = (0, _types_1.createPlugin)({
    ...
    const dartFiles = [...(0, _types_1.getDanger)().git.modified_files, ...(0, _types_1.getDanger)().git.created_files].filter((f) => f.endsWith(".dart") &&
        !f.includes(".g.dart") &&
...
function parseCspellOutput(output, metadata) {
    ...
    return errors.filter((e, i, self) => i ===
        self.findIndex((x) => x.originalFile === e.originalFile && x.line === e.line && x.word === e.word));
}
