...
function getDangerResults() {
    ...
    if (!results)
        return { fails: 0, warnings: 0, messages: 0 };
    return {
...
exports.default = (0, _types_1.createPlugin)({
    ...
    if (!webhookUrl) {
        console.log("⚠️ google-chat-notification: nenhum webhook configurado. " +
    ...
    try {
        ...
        console.log(`⚠️ Google Chat falha ao enviar: ${err instanceof Error ? err.message : String(err)}`);
    }
});
