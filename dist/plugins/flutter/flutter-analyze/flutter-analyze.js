...
exports.default = (0, _types_1.createPlugin)({
    ...
    try {
        ...
        if (filteredLines.length === 0) {
            (0, _types_1.sendMessage)("✅ **Flutter Analyze**: Nenhum problema encontrado nos arquivos alterados!");
            return;
        }
        ...
        (0, _types_1.sendMessage)("⚠️ **Flutter Analyze**: Erro ao executar análise. Verifique os logs.");
    }
});
function translateFlutterAnalyzeMessage(message, ruleName) {
    const translations = {
        ...
        body_might_complete_normally: "Corpo da função pode terminar sem retornar — tipo de retorno é non-nullable",
        body_might_complete_normally_nullable: "Corpo da função termina sem retornar valor — tipo de retorno é nullable",
        not_initialized_non_nullable_variable: "Variável non-nullable não inicializada — atribua um valor",
        missing_default_value_for_parameter: "Parâmetro non-nullable sem valor padrão — use 'required' ou atribua valor padrão",
        unchecked_use_of_nullable_value: "Uso de valor nullable sem verificação — verifique null antes de usar",
        dead_null_aware_expression: "Operando esquerdo nunca é null — expressão null-aware desnecessária",
        ...
        non_abstract_class_inherits_abstract_member: "Classe concreta herda membro abstrato — implemente o membro faltante",
        must_call_super: "Método sobrescrito marcado com @mustCallSuper — chame super no override",
        // ── Diagnostics: Acesso e visibilidade ──
        invalid_use_of_protected_member: "Membro protegido (@protected) — só pode ser usado em subclasses",
        invalid_use_of_visible_for_testing_member: "Membro marcado @visibleForTesting — só pode ser usado em testes",
        // ── Diagnostics: Constantes ──
        const_with_non_const: "Construtor chamado não é const",
        const_initialized_with_non_constant_value: "Variável const deve ser inicializada com valor constante",
        ...
        non_type_as_type_argument: "Identificador não é um tipo — não pode ser usado como argumento de tipo genérico",
        wrong_number_of_type_arguments: "Número incorreto de argumentos de tipo genérico",
        type_argument_not_matching_bounds: "Argumento de tipo não respeita a restrição (bound) do tipo genérico",
        ...
        subtype_of_sealed_class: "Classe sealed não pode ser estendida, implementada ou usada como mixin fora da biblioteca",
        implicit_this_reference_in_initializer: "Membro de instância não pode ser acessado em inicializador",
        initializing_formal_for_non_existent_field: "Parâmetro de inicialização referencia campo inexistente",
        ...
        dead_code_catch_following_catch: "Código morto: cláusulas catch após 'catch(e)' genérico nunca serão alcançadas",
        dead_code_on_catch_subtype: "Código morto: catch de subtipo nunca será executado — já foi capturado acima",
        ...
        missing_code_block_language_in_doc_comment: "Especifique a linguagem no bloco de código do doc comment",
        ...
        specify_nonobvious_local_variable_types: "Especifique o tipo quando não for óbvio em variáveis locais",
        ...
        unnecessary_null_aware_operator_on_extension_on_nullable: "Operador null-aware desnecessário em extensão de tipo nullable",
        unnecessary_nullable_for_final_variable_declarations: "Tipo nullable desnecessário em variável final",
        ...
        prefer_interpolation_to_compose_strings: "Use interpolação ao invés de concatenar strings com +",
        prefer_adjacent_string_concatenation: "Use strings adjacentes ao invés de +",
        missing_whitespace_between_adjacent_strings: "Faltando espaço entre strings adjacentes — possível bug",
        ...
        prefer_if_elements_to_conditional_expressions: "Use if dentro de coleções ao invés de operador ternário",
        ...
        avoid_catches_without_on_clauses: "Evite catch sem cláusula on — especifique o tipo de exceção (ex: on Exception catch(e))",
        ...
        prefer_constructors_over_static_methods: "Prefira construtores ao invés de métodos estáticos para criação",
        ...
        avoid_classes_with_only_static_members: "Evite classes com apenas membros estáticos — use funções top-level",
        use_enums: "Use enum ao invés de classe com constantes",
        // ── Funções e closures ──
        prefer_function_declarations_over_variables: "Prefira declarações de função ao invés de variáveis",
        ...
        avoid_bool_literals_in_conditional_expressions: "Evite literais bool em expressões condicionais",
        ...
        invalid_runtime_check_with_js_interop_types: "Verificação de runtime inválida com tipos JS interop",
        ...
        use_late_for_private_fields_and_variables: "Use late para campos e variáveis privados inicializados tardiamente",
        ...
        remove_deprecations_in_breaking_versions: "Remova membros depreciados em versões com breaking changes",
