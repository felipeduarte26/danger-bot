...
function looksLikeDateField(name) {
    ...
    if (EXACT_NAMES.has(lower))
        return true;
    if (DATE_PREFIX_EXCLUSIONS.has(lower))
        return false;
...
function isEntityOrModelFile(filePath) {
    ...
    return (lower.includes("/entities/") ||
...
exports.default = (0, _types_1.createPlugin)({
    ...
    description: "Detecta campos com nome de data declarados como String ao invés de DateTime em entities e models",
    enabled: true,
}, async () => {
    ...
    for (const file of dartFiles) {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            (0, _types_1.sendFormattedFail)({
                ...
                objective: "Usar `DateTime` para campos de data garante **tipagem segura**, permite operações nativas (comparação, formatação, diferença) e evita erros de parsing em runtime.",
                reference: {
