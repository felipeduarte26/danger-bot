    ...
    for (const file of dartFiles) {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            (0, _types_1.sendFormattedFail)({
                ...
                description: "`late final` com valor atribuído na declaração não faz sentido. O `late` só é necessário quando a atribuição acontece **depois** (ex: `initState`, `didChangeDependencies`).",
                problem: {
                    wrong: trimmed,
